...
#ifndef __LISBASE_UTIL_ASSERTX_H__
#define __LISBASE_UTIL_ASSERTX_H__
...
void __assert__format__(const char* file, uint32_t line, const char* func, const char* expr, const I8* format, ...);
